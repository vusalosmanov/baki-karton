...
import NewsContent from "@/components/NewsContent"; // Yeni yaradacağımız komponent

export default async function NewsPage() {
    const newsFromStrapi = await getNews();
    ...
    return (
        <main className="min-h-screen bg-[#f8fafc]">
            ...
            <div className="max-w-7xl mx-auto px-6 -mt-10 relative z-20 pb-24">
                <NewsContent initialNews={newsFromStrapi} />
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 mb-24">
                <div className="bg-[#1a3352] rounded-[2.5rem] p-12 relative overflow-hidden flex flex-col md:flex-row items-center justify-between shadow-2xl">
                    <div className="relative z-10 text-center md:text-left mb-8 md:mb-0">
                        <h2 className="text-3xl font-bold text-white">Yenilikləri qaçırmayın</h2>
                        <p className="text-blue-200 mt-2">E-poçtunuzu qeyd edin, ən son xəbərlər sizə gəlsin.</p>
                    </div>
