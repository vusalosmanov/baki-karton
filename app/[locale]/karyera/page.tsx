...
export default function KaryeraPage() {
    ...
    const careerData = [
        {
            id: "recruitment",
            title: "İşə Qəbul Siyasəti",
            shortDesc: "Şəffaf və ləyaqətli işə qəbul prosesi.",
            fullDesc: (
                <>
                    Bakı Karton, qloballaşan dünyada rəqabətdə fərq yaratmaq üçün ən vacib sərmayəsinin insan resursları olduğunun fərqindədir.
                    Bu məqsədlə əməkdaşlarının motivasiya və məmnuniyyətinə böyük əhəmiyyət verir.
                    <br /><br />
                    Tərkibində minlərlə insana iş imkanı yaradan <span className="font-bold text-slate-800">Bakı Karton</span>, öz inkişafını və böyüməsini davam etdirərkən, cəmiyyətə faydalı olmağın qürurunu yaşayır. <br /><br />
                    <span className="font-bold text-slate-800"> Bakı Karton</span> olaraq, çalışdığı qurumun gələcəyi ilə öz həyatını birləşdirən və gördüyü işlərlə dəyər yaradan insanların formalaşdırdığı bir quruluşa inanırıq.
                </>
            ),
            icon: (
        ...
        },
        {
            ...
            shortDesc: "Peşəkar bacarıqların artırılması və davamlı öyrənmə.",
            fullDesc: (
                <>
                    Bakı Karton, vizyonu və gələcək strategiyaları çərçivəsində, müxtəlif səviyyələrdə fəaliyyət göstərən əməkdaşların təlim və inkişaf fəaliyyətlərini eyni səviyyəyə çatdırmaq məqsədilə təlimlərini davam etdirir.
                    <br /><br />
                    Bu məqsədlə qurulan <span className="font-bold text-slate-800">Bakı Karton Akademiyası</span>, əməkdaşların fərdi tələbləri ilə yanaşı, şirkətin ehtiyaclarını da nəzərə alır.
                    <br /><br />
                    Təlimlərimiz, <span className="font-bold text-slate-800">Oryentasiya Təlimləri</span>, <span className="font-bold text-slate-800">Fərdi İnkişaf Təlimləri</span> və <span className="font-bold text-slate-800">Texniki İnkişaf Təlimləri</span> olaraq kateqoriyalara ayrılır.
                </>
            ),
            icon: (
                <svg className="w-5 h-5 md:w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            formData.append("message", `Karyera bölməsindən yeni müraciət var. Seçilən bölmə: ${activeCareer.title}`);
            if (file) {
                ...
                <div className="relative mb-12 md:mb-20 lg:mb-24 overflow-hidden rounded-3xl md:rounded-[3rem] bg-slate-900 p-8 md:p-16 lg:p-24 shadow-2xl">
                    ...
                    <div className="relative z-10 max-w-4xl">
                        ...
                        <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white leading-[1.15] mb-6 md:mb-8">
                            Gələcəyinizi <br />
                            <span className="text-[#004a99]">Bizimlə Qablaşdırın.</span>
                        </h2>
                        <p className="text-slate-400 text-base sm:text-lg md:text-xl lg:text-2xl font-medium leading-relaxed max-w-2xl">
                            Bakı Karton-da biz sadəcə qutu istehsal etmirik, həm də peşəkar gələcəyinizi dayanıqlı təməllər üzərində qururuq.
                        </p>
                    </div>
                </div>
                            ...
                            {careerData.map((item) => (
                                ...
                                >
                                    ...
                                    <div className="text-left min-w-0">
                                        ...
                                        <p className={`text-[11px] md:text-xs line-clamp-1 ${activeCareerId === item.id ? "text-white/70" : "text-slate-400"}`}>
                                            {item.shortDesc}
                                        </p>
                                    </div>
                                </button>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm overflow-y-auto">
                    <div className="bg-white w-full max-w-md rounded-[2rem] md:rounded-[2.5rem] p-6 sm:p-10 shadow-2xl relative my-8">
                        ...
                        <p className="text-slate-500 text-xs md:text-sm mb-6 md:mb-8">CV-nizi bizə göndərin.</p>

                        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
                            <div>
                                <label className="block text-[9px] md:text-[10px] font-black uppercase text-[#004a99] tracking-widest mb-1 md:mb-2 ml-1">Ad və Soyad</label>
                                <input
                                    name="fullname"
                                    required
                                    type="text"
                            ...
                            <div>
                                <label className="block text-[9px] md:text-[10px] font-black uppercase text-[#004a99] tracking-widest mb-1 md:mb-2 ml-1">E-poçt</label>
                                <input
                                    name="email"
                                    required
                                    type="email"
                            ...
                            <div>
                                <label className="block text-[9px] md:text-[10px] font-black uppercase text-[#004a99] tracking-widest mb-1 md:mb-2 ml-1">CV (PDF)</label>
                                <div className="relative h-20 md:h-24 group">
                                    ...
                                    />
                                    <div className={`absolute inset-0 w-full h-full border-2 border-dashed rounded-xl md:rounded-2xl flex flex-col items-center justify-center pointer-events-none z-10 transition-all ${selectedFileName ? "border-green-500 bg-green-50/30" : "border-slate-200 bg-slate-50 group-hover:border-[#004a99]"}`}>
                                        <span className="text-xs md:text-sm text-slate-400 font-bold px-4 text-center line-clamp-1">
                                            {selectedFileName ? `✅ ${selectedFileName}` : "Seçmək üçün klikləyin"}
                                        </span>
                                    </div>
                                </div>
                            </div>
