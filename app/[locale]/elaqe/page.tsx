...
export default async function ContactPage({ params }: ContactPageProps) {
  ...
  const currentLocale = (locale === "en" ? "en" : "az") as "az" | "en";

  const dict = (await getDictionary(currentLocale)) as Record<string, any>;
  ...
  return (
    <section className="w-full bg-[#f4f7fa] px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="max-w-7xl mx-auto mt-10 pt-[200px] lg:mt-0">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4 group">
                ...
                <div className="min-w-0">
                  ...
                  <p className="font-medium text-base sm:text-lg italic truncate">
                    {t.emailValue}
                  </p>
                </div>
              </div>
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:grid-cols-2 sm:gap-8">
              <div className="relative group">
                <input
                  type="text"
                  id="name"
                  className="peer w-full bg-transparent border-b-2 border-gray-200 py-3 outline-none focus:border-[#1a3352] transition-colors placeholder-transparent"
                  placeholder="Ad Soyad"
                />

                <label
                  htmlFor="name"
                  className="absolute left-0 -top-3.5 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:top-3 peer-focus:-top-3.5 peer-focus:text-[#1a3352]"
                >{t.namePlaceholder}
                </label>
              </div>
              ...
              <div className="relative group">
                ...
                >
                  <option value="Mövzu" disabled>
                    {t.selectSubject}
                  </option>

                  <option value="Karton list sifarişi">
                    Karton list sifarişi
                  </option>
              ...
              <div className="md:col-span-2 relative group mt-4">
                <textarea
                  id="msg"
                  rows={3}
                  className="peer w-full bg-transparent border-b-2 border-gray-200 py-3 outline-none focus:border-[#1a3352] transition-colors placeholder-transparent resize-none"
                  placeholder="Mesaj"
                ></textarea>
